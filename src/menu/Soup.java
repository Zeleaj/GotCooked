...
public class Soup extends Menu implements Cookable{
	// Constants
    private static final String NAME_UNCOOKED = "Soup (Uncooked)";
    private static final String NAME_COOKED = "Soup";

    // Instance field
    private boolean cooked = false;

    public Soup() {
        super(NAME_UNCOOKED, MenuRecipe.ALL_RECIPES.get("Soup").getIngredients());
    }
